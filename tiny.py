...
try:
    ...
    import ZeroBorg
    print('ZeroBorg library available.')
    zb = ZeroBorg.ZeroBorg()
    zb.init()

    def set_speeds(front_left, front_right, rear_left, rear_right):
        """
        ...
        :param rear_right:
            Power to send to right motor, will be inverted to reflect chassis layout
        """
        zb.set_motor1(-power_right)
        zb.set_motor2(power_left)
        zb.set_motor3(-power_right)
        zb.set_motor4(power_left)
    ...
    def set_speeds(front_left, front_right, rear_left, rear_right):
        ...
        """
        print('Front: Left: {}, Right: {} Rear: Left: {}, Right: {} '.format(
